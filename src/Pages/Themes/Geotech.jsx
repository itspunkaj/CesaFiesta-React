function point(text){
  ...
  function Geotech() {
    return (
        <div className={`geotech flex justify-center items-center bg-cover bg-no-repeat bg-center min-h-[100vh]`}>
        <div className="flex justify-center w-[90%] max-w-[800px] md:w-[40%] md:ml-[50%] my-10 h-96 flex-col rounded-lg
          ...
          <h1 className="text-3xl md:text-4xl py-2 md:py-3 font-semibold font-sans text-center">Geotechnical Engineering</h1>
          ...
          <ul className="pb-5 text-gray-800 px-5 font-medium text-sm md:text-base">
            ...
            {point('Geomaterial Characterization, Site Investigation and Exploration')}
            {point('Ground Improvement')}
            {point('Dynamic Behaviour of Soils and Rocks')}
            {point('Rock Mechanics')}
            {point('Landslides and Slope Stability')}
            {point('Modeling in Geotechnical Engineering')}
          </ul>
