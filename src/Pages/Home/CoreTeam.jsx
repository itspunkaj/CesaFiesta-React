...
function CoreTeam() {
    return (
        <div className="bg-fourthColor">
            ...
            <Card imageUrl={DrShray} name="Dr. Shray Pathak" designation="Convenor" link="https://scholar.google.co.in/citations?user=JId_NPEAAAAJ&hl=en"/>
            <Card imageUrl={DrGanesh} name="Dr. Ganesh Ravi" designation="Co-Convenor" link="https://scholar.google.com/citations?user=GYBJrXoAAAAJ&hl=en&oi=sra"/>
