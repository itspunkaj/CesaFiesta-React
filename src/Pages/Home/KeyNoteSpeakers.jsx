...
const Card = (props) => {
    return (
        <div className="flex flex-col justify-around bg-fourthColor h-auto min-h-64 w-[175px] sm:w-[180px] md:w-[200px] border-4 border-firstColor rounded-xl shadow-sm py-3-2">
