        ...
        <div className='justify-center w-[90%] max-w-[1100px] lg:w-[80%] my-10 h-auto min-h-[90%] grid grid-cols-12 divide-x divide-solid divide-firstColor'>
          ...
          <div className="col-span-12 md:col-span-4 pl-4">
            ...
            <div className="my-10 text-lg leading-relaxed">
              ...
              <li><a className="text-firstColor font-medium hover:text-thirdColor py-2" href='https://docs.google.com/forms/d/1iiGa5AA9uz5bLkGdLJyC5xtrRhNjqwVFy5E1TUmtxoc/edit' target='https://docs.google.com/forms/d/1iiGa5AA9uz5bLkGdLJyC5xtrRhNjqwVFy5E1TUmtxoc/edit'>Click here </a> to register</li>
                <li><a className="text-firstColor font-medium hover:text-thirdColor py-3" href='https://docs.google.com/presentation/d/1mPXSCvjDbYVOnD0bi9o0bgFD0vZW4xr3/edit#slide=id.p1' target='blank_'>Presentation template</a></li>
                <li><a className="text-firstColor font-medium hover:text-thirdColor py-3" href='https://docs.google.com/presentation/d/1mQgTIQtOpmEj2hbELKVoTWTv33eUm8jW/edit#slide=id.p1' target='blank_'>Poster template</a></li>
              </ul>
            </div>
          </div>
        </div>
