          ...
          <table className="table-fixed border-collapse border-spacing-2 border-2 w-[1000px] border-slate-300">
            ...
            <tbody>
              <tr className="hover:transform hover:scale-[1.02] hover:bg-[#f8f9fa] transition-transform duration-200 ease-in-out">
                ...
                <td className="md:text-[18px] border-2 border-slate-300 py-4 px-3">Last Date 20th January 2026</td>
              </tr>
              <tr className="hover:transform hover:scale-[1.02] hover:bg-[#f8f9fa] transition-transform duration-200 ease-in-out">
                <td className="md:text-[18px] border-2 border-slate-300 py-4 px-3">Notification of Acceptance</td>
                <td className="md:text-[18px] border-2 border-slate-300 py-4 px-3">15th January onwards</td>
              </tr>
              <tr className="hover:transform hover:scale-[1.02] hover:bg-[#f8f9fa] transition-transform duration-200 ease-in-out">
                ...
                <td className="md:text-[18px] border-2 border-slate-300 py-4 px-3"><div><b>Early Bird offer</b> - 10th to 30th January 2026</div>
                          <div><b>Regular fees</b> - 31st January to 15th February 2026</div></td>
              </tr>
              <tr className="hover:transform hover:scale-[1.02] hover:bg-[#f8f9fa] transition-transform duration-200 ease-in-out">
              ...
              <tr className="hover:transform hover:scale-[1.02] hover:bg-[#f8f9fa] transition-transform duration-200 ease-in-out">
                ...
                <td className="md:text-[18px] border-2 border-slate-300 py-4 px-3">Indian Institute of Technology Ropar</td>
              </tr>
            </tbody>
          </table>
        </div>
