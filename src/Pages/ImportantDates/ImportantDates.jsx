    ...
    return (
      <div className="pb-32 bg-fourthColor">
        ...
        <div className="flex justify-center text-center px-10">
          <table className="table-fixed border-collapse border-spacing-2 border-2 w-[800px] border-slate-300">
            <thead>
            ...
            <tbody>
              ...
              <tr className="hover:transform hover:scale-[1.02] hover:bg-[#f8f9fa] transition-transform duration-200 ease-in-out">
                ...
                <td className="md:text-[18px] border-2 border-slate-300 py-4 px-3">1st week of November 2024</td>
              </tr>
              <tr className="hover:transform hover:scale-[1.02] hover:bg-[#f8f9fa] transition-transform duration-200 ease-in-out">
